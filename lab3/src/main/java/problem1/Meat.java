...
public class Meat extends Food implements Perishable {
  /**
   * Constructor for meat, initialize its name, current price per unit, available quantity, and
   * Maximum allowed quantity
   * @param name name of this food
   * @param pricePerUnit price per unit
   * @param availableNum available quantity
   */
  public Meat(String name, double pricePerUnit, Integer availableNum) {
